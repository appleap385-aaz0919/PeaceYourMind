  ...
  return (
    <div>
      ...
      {fallback.length > 0 ? (
        ...
        //
        // ★ 2026-08-28 재검토 — **그대로 두기로 확정했다** (사용자 결정).
        //   배치가 폴백에 90일 컷 + 화면별 무작위를 넣으면서 노출 나이의
        //   중앙값이 1~2일에서 13~17일로 올라간다(90분위 42~68일 · 상한 90일).
        //   "요즘"의 체감이 전보다 흐려지는 것을 알고 두는 것이다.
        //   ★ 그래도 이 문장은 **전보다 참이 됐다** — 지금까지는 상한이 아예 없어
        //     247일·272일짜리가 "요즘"이라는 이름으로 나가고 있었다.
        //     컷이 그 주장에 처음으로 강제력을 준다.
        //   ⛔ 기간을 명시하는 문구("최근 3개월 안에 올라온")로 바꾸지 말 것.
        //     이 문장의 무게 중심은 "요즘"이 아니라 **"딱 맞는 건 아니지만"** 이고,
        //     정직성 주장은 주제 적합성이지 신선도가 아니다. 기간을 넣으면
        //     위 2026-08-19 개정이 잡은 어조에서 벗어난다.
        <Section
